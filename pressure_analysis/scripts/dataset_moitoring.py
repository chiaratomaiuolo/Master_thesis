...
if __name__ == "__main__":
    ...
    #start_times = [['2024-02-12 15:32:00.000', '2024-02-16 18:00:00.000', '2024-02-19 18:30:00.000']]
    #stop_times = [['2024-02-16 14:00:00.000', '2024-02-19 11:30:00.000', '2024-02-20 12:30:00.000']]
    ...
    #stop_times = [['2024-02-19 15:40:00.000']]
    ...
    start_times = [['2024-03-15 16:00:35.000']]
    stop_times = [['2024-04-04 12:40:00.000']]
    ...
    #rms = np.sqrt((1/len(P_eq))*((np.mean(P_eq)-P_eq)**2).sum())
    #print(f'The RMSD is: {rms}')
    ...
    #axs[0].axhline(1201., color='blue', label='Pressure at filling time')
    axs[0].axhline(979.2, color='green', label='Pressure before heating')
    ...
    plt.figure('Fit to pressure variations without epoxy samples inside')
    plt.errorbar(t_hours, P_eq, marker='.')
